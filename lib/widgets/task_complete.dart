...
class TaskCompleteContainer extends StatefulWidget {
  ...
  @override
  _TaskCompleteContainerState createState() => _TaskCompleteContainerState();
}

class _TaskCompleteContainerState extends State<TaskCompleteContainer> {
